...
var diamond = preload("res://Misc Objects/Diamond.tscn")
var dirtTiles
var solidTiles
var dying = false
...
func spawn_diamond(relPos):
	var obj = diamond.instance()
	get_parent().add_child(obj)
	obj.position = relPos * tileSize + position
